        ...
        <section className='pt-20'>
          ...
          <section>
            <div class="inset-x-0 relative  w-full grid grid-cols-4">
              ...
              <a href="documento/COMPINA SOSTENIBLE.pdf" download="presentacion" className='cursor-pointer h-[80px] py-4 col-span-4 md:col-span-2 lg:col-span-1 flex justify-center items-center bg-black text-white'><i class="fa-solid fa-file-pdf text-2xl"></i><h3 className='px-2'>VIEW PRESENTATION</h3></a>
