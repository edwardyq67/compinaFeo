        ...
        <section className='pt-20'>
          ...
          <section>
            <div class="inset-x-0 relative  w-full grid grid-cols-4">
              ...
              <a href="./document/presentacion.pdf" download="COMPINA_SOSTENIBLE.pdf" className='cursor-pointer h-[80px] py-4 col-span-4 md:col-span-2 lg:col-span-1 flex justify-center items-center bg-black text-white'>
